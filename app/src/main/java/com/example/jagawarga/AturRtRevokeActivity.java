...
public class AturRtRevokeActivity extends AppCompatActivity {
    ...
    private void setupTabs() {
        // Tab Promosikan → pindah ke activity Promosikan
        tabPromosikan.setOnClickListener(v -> {
            startActivity(new android.content.Intent(
                    AturRtRevokeActivity.this,
                    AturRtPromoteActivity.class
            ));
            finish();
        });
    ...
    private void setupButton() {
        btnAction.setOnClickListener(v -> {
            ...
            callAturRtApi("turunkan", idWarga, telepon);
        });
    }
